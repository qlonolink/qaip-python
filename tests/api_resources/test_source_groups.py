...
class TestSourceGroups:
    ...
    def test_method_retrieve(self, client: Qaip) -> None:
        source_group = client.source_groups.retrieve(
            "source_group_id",
        )
        assert_matches_type(SourceGroup, source_group, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: Qaip) -> None:
        response = client.source_groups.with_raw_response.retrieve(
            "source_group_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        source_group = response.parse()
        assert_matches_type(SourceGroup, source_group, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_retrieve(self, client: Qaip) -> None:
        with client.source_groups.with_streaming_response.retrieve(
            "source_group_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Qaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `source_group_id` but received ''"):
            client.source_groups.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_list(self, client: Qaip) -> None:
        source_group = client.source_groups.list()
        assert_matches_type(SourceGroupListResponse, source_group, path=["response"])
    ...
    def test_raw_response_list(self, client: Qaip) -> None:
        response = client.source_groups.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Qaip) -> None:
        with client.source_groups.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_batch_set_metadata(self, client: Qaip) -> None:
        source_group = client.source_groups.batch_set_metadata(
            items=[
                {
                    "metadata": {},
        ...
        assert_matches_type(BatchSetMetadataResponse, source_group, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_batch_set_metadata(self, client: Qaip) -> None:
        response = client.source_groups.with_raw_response.batch_set_metadata(
            items=[
                {
                    "metadata": {},
                    "source_group_id": "source_group_id",
    ...
    def test_streaming_response_batch_set_metadata(self, client: Qaip) -> None:
        with client.source_groups.with_streaming_response.batch_set_metadata(
            items=[
                {
                    "metadata": {},
                    "source_group_id": "source_group_id",
    ...
    def test_method_delete_metadata(self, client: Qaip) -> None:
        source_group = client.source_groups.delete_metadata(
            "source_group_id",
        )
        assert_matches_type(SourceGroupDeleteMetadataResponse, source_group, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_delete_metadata(self, client: Qaip) -> None:
        response = client.source_groups.with_raw_response.delete_metadata(
            "source_group_id",
        )
    ...
    def test_streaming_response_delete_metadata(self, client: Qaip) -> None:
        with client.source_groups.with_streaming_response.delete_metadata(
            "source_group_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete_metadata(self, client: Qaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `source_group_id` but received ''"):
            client.source_groups.with_raw_response.delete_metadata(
                "",
            )
    ...
    def test_method_retrieve_metadata(self, client: Qaip) -> None:
        source_group = client.source_groups.retrieve_metadata(
            "source_group_id",
        )
        assert_matches_type(Metadata, source_group, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve_metadata(self, client: Qaip) -> None:
        response = client.source_groups.with_raw_response.retrieve_metadata(
            "source_group_id",
        )
    ...
    def test_streaming_response_retrieve_metadata(self, client: Qaip) -> None:
        with client.source_groups.with_streaming_response.retrieve_metadata(
            "source_group_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve_metadata(self, client: Qaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `source_group_id` but received ''"):
            client.source_groups.with_raw_response.retrieve_metadata(
                "",
            )
    ...
    def test_method_update_metadata(self, client: Qaip) -> None:
        source_group = client.source_groups.update_metadata(
            source_group_id="source_group_id",
            metadata={},
        )
        assert_matches_type(Metadata, source_group, path=["response"])
    ...
    def test_raw_response_update_metadata(self, client: Qaip) -> None:
        response = client.source_groups.with_raw_response.update_metadata(
            source_group_id="source_group_id",
            metadata={},
        )
    ...
    def test_streaming_response_update_metadata(self, client: Qaip) -> None:
        with client.source_groups.with_streaming_response.update_metadata(
            source_group_id="source_group_id",
            metadata={},
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update_metadata(self, client: Qaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `source_group_id` but received ''"):
            client.source_groups.with_raw_response.update_metadata(
                source_group_id="",
                metadata={},
            )


class TestAsyncSourceGroups:
    ...
    async def test_method_retrieve(self, async_client: AsyncQaip) -> None:
        source_group = await async_client.source_groups.retrieve(
            "source_group_id",
        )
        assert_matches_type(SourceGroup, source_group, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncQaip) -> None:
        response = await async_client.source_groups.with_raw_response.retrieve(
            "source_group_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        source_group = await response.parse()
        assert_matches_type(SourceGroup, source_group, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncQaip) -> None:
        async with async_client.source_groups.with_streaming_response.retrieve(
            "source_group_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncQaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `source_group_id` but received ''"):
            await async_client.source_groups.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_list(self, async_client: AsyncQaip) -> None:
        source_group = await async_client.source_groups.list()
        assert_matches_type(SourceGroupListResponse, source_group, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncQaip) -> None:
        response = await async_client.source_groups.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncQaip) -> None:
        async with async_client.source_groups.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_batch_set_metadata(self, async_client: AsyncQaip) -> None:
        source_group = await async_client.source_groups.batch_set_metadata(
            items=[
                {
                    "metadata": {},
                    "source_group_id": "source_group_id",
    ...
    async def test_raw_response_batch_set_metadata(self, async_client: AsyncQaip) -> None:
        response = await async_client.source_groups.with_raw_response.batch_set_metadata(
            items=[
                {
                    "metadata": {},
                    "source_group_id": "source_group_id",
    ...
    async def test_streaming_response_batch_set_metadata(self, async_client: AsyncQaip) -> None:
        async with async_client.source_groups.with_streaming_response.batch_set_metadata(
            items=[
                {
                    "metadata": {},
                    "source_group_id": "source_group_id",
    ...
    async def test_method_delete_metadata(self, async_client: AsyncQaip) -> None:
        source_group = await async_client.source_groups.delete_metadata(
            "source_group_id",
        )
        assert_matches_type(SourceGroupDeleteMetadataResponse, source_group, path=["response"])
    ...
    async def test_raw_response_delete_metadata(self, async_client: AsyncQaip) -> None:
        response = await async_client.source_groups.with_raw_response.delete_metadata(
            "source_group_id",
        )
    ...
    async def test_streaming_response_delete_metadata(self, async_client: AsyncQaip) -> None:
        async with async_client.source_groups.with_streaming_response.delete_metadata(
            "source_group_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete_metadata(self, async_client: AsyncQaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `source_group_id` but received ''"):
            await async_client.source_groups.with_raw_response.delete_metadata(
                "",
            )
    ...
    async def test_method_retrieve_metadata(self, async_client: AsyncQaip) -> None:
        source_group = await async_client.source_groups.retrieve_metadata(
            "source_group_id",
        )
        assert_matches_type(Metadata, source_group, path=["response"])
    ...
    async def test_raw_response_retrieve_metadata(self, async_client: AsyncQaip) -> None:
        response = await async_client.source_groups.with_raw_response.retrieve_metadata(
            "source_group_id",
        )
    ...
    async def test_streaming_response_retrieve_metadata(self, async_client: AsyncQaip) -> None:
        async with async_client.source_groups.with_streaming_response.retrieve_metadata(
            "source_group_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_metadata(self, async_client: AsyncQaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `source_group_id` but received ''"):
            await async_client.source_groups.with_raw_response.retrieve_metadata(
                "",
            )
    ...
    async def test_method_update_metadata(self, async_client: AsyncQaip) -> None:
        source_group = await async_client.source_groups.update_metadata(
            source_group_id="source_group_id",
            metadata={},
        )
        assert_matches_type(Metadata, source_group, path=["response"])
    ...
    async def test_raw_response_update_metadata(self, async_client: AsyncQaip) -> None:
        response = await async_client.source_groups.with_raw_response.update_metadata(
            source_group_id="source_group_id",
            metadata={},
        )
    ...
    async def test_streaming_response_update_metadata(self, async_client: AsyncQaip) -> None:
        async with async_client.source_groups.with_streaming_response.update_metadata(
            source_group_id="source_group_id",
            metadata={},
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update_metadata(self, async_client: AsyncQaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `source_group_id` but received ''"):
            await async_client.source_groups.with_raw_response.update_metadata(
                source_group_id="",
                metadata={},
            )

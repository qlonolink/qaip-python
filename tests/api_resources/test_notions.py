...
class TestNotions:
    ...
    def test_method_create(self, client: Qaip) -> None:
        ...
        assert_matches_type(Notion, notion, path=["response"])
    ...
    def test_raw_response_create(self, client: Qaip) -> None:
        response = client.notions.with_raw_response.create(
            name="name",
            page_id="page_id",
        )
        ...
        notion = response.parse()
        assert_matches_type(Notion, notion, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_create(self, client: Qaip) -> None:
        with client.notions.with_streaming_response.create(
            name="name",
            page_id="page_id",
        ) as response:
    ...
    def test_method_retrieve(self, client: Qaip) -> None:
        notion = client.notions.retrieve(
            "id",
        )
        assert_matches_type(Notion, notion, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: Qaip) -> None:
        response = client.notions.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Qaip) -> None:
        with client.notions.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Qaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.notions.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_list(self, client: Qaip) -> None:
        notion = client.notions.list()
        assert_matches_type(NotionListResponse, notion, path=["response"])
    ...
    def test_raw_response_list(self, client: Qaip) -> None:
        response = client.notions.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Qaip) -> None:
        with client.notions.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_delete(self, client: Qaip) -> None:
        response = client.notions.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: Qaip) -> None:
        with client.notions.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Qaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.notions.with_raw_response.delete(
                "",
            )
    ...
    def test_method_retrieve_setting(self, client: Qaip) -> None:
        notion = client.notions.retrieve_setting(
            "id",
        )
        assert_matches_type(NotionSetting, notion, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve_setting(self, client: Qaip) -> None:
        response = client.notions.with_raw_response.retrieve_setting(
            "id",
        )
    ...
    def test_streaming_response_retrieve_setting(self, client: Qaip) -> None:
        with client.notions.with_streaming_response.retrieve_setting(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve_setting(self, client: Qaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.notions.with_raw_response.retrieve_setting(
                "",
            )
    ...
    def test_method_update_setting(self, client: Qaip) -> None:
        notion = client.notions.update_setting(
            id="id",
            name="name",
        )
        assert_matches_type(NotionSetting, notion, path=["response"])
    ...
    def test_raw_response_update_setting(self, client: Qaip) -> None:
        response = client.notions.with_raw_response.update_setting(
            id="id",
            name="name",
        )
    ...
    def test_streaming_response_update_setting(self, client: Qaip) -> None:
        with client.notions.with_streaming_response.update_setting(
            id="id",
            name="name",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update_setting(self, client: Qaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.notions.with_raw_response.update_setting(
                id="",
                name="name",
            )


class TestAsyncNotions:
    ...
    async def test_method_create(self, async_client: AsyncQaip) -> None:
        notion = await async_client.notions.create(
            name="name",
            page_id="page_id",
        )
        assert_matches_type(Notion, notion, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncQaip) -> None:
        response = await async_client.notions.with_raw_response.create(
            name="name",
            page_id="page_id",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        notion = await response.parse()
        assert_matches_type(Notion, notion, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncQaip) -> None:
        async with async_client.notions.with_streaming_response.create(
            name="name",
            page_id="page_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_retrieve(self, async_client: AsyncQaip) -> None:
        notion = await async_client.notions.retrieve(
            "id",
        )
        assert_matches_type(Notion, notion, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncQaip) -> None:
        response = await async_client.notions.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncQaip) -> None:
        async with async_client.notions.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncQaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.notions.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_list(self, async_client: AsyncQaip) -> None:
        notion = await async_client.notions.list()
        assert_matches_type(NotionListResponse, notion, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncQaip) -> None:
        response = await async_client.notions.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncQaip) -> None:
        async with async_client.notions.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncQaip) -> None:
        notion = await async_client.notions.delete(
            "id",
        )
        assert_matches_type(Notion, notion, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncQaip) -> None:
        response = await async_client.notions.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncQaip) -> None:
        async with async_client.notions.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncQaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.notions.with_raw_response.delete(
                "",
            )
    ...
    async def test_method_retrieve_setting(self, async_client: AsyncQaip) -> None:
        notion = await async_client.notions.retrieve_setting(
            "id",
        )
        assert_matches_type(NotionSetting, notion, path=["response"])
    ...
    async def test_raw_response_retrieve_setting(self, async_client: AsyncQaip) -> None:
        response = await async_client.notions.with_raw_response.retrieve_setting(
            "id",
        )
    ...
    async def test_streaming_response_retrieve_setting(self, async_client: AsyncQaip) -> None:
        async with async_client.notions.with_streaming_response.retrieve_setting(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_setting(self, async_client: AsyncQaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.notions.with_raw_response.retrieve_setting(
                "",
            )
    ...
    async def test_method_update_setting(self, async_client: AsyncQaip) -> None:
        notion = await async_client.notions.update_setting(
            id="id",
            name="name",
        )
        assert_matches_type(NotionSetting, notion, path=["response"])
    ...
    async def test_raw_response_update_setting(self, async_client: AsyncQaip) -> None:
        response = await async_client.notions.with_raw_response.update_setting(
            id="id",
            name="name",
        )
    ...
    async def test_streaming_response_update_setting(self, async_client: AsyncQaip) -> None:
        async with async_client.notions.with_streaming_response.update_setting(
            id="id",
            name="name",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update_setting(self, async_client: AsyncQaip) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.notions.with_raw_response.update_setting(
                id="",
                name="name",
            )

...
RESOURCES: dict[str, dict[str, Any]] = {
    ...
    "local-file-groups": {
        ...
        "methods": {
            "start_bulk_deletion": {
                "http_method": "POST",
                "path": "/local-file-groups/bulk-deletions",
                "required_params": ["source_group_ids"],
                "optional_params": [],
                "requires_confirmation": True,
            },
            "start_chunk_deletion": {
                "http_method": "POST",
                "path": "/local-file-groups/{id}/chunk-deletions",
                "required_params": ["id", "text_contains"],
                "optional_params": [],
                "requires_confirmation": True,
            },
            "retrieve_bulk_deletion": {
                "http_method": "GET",
                "path": "/local-file-groups/bulk-deletions/{bulk_deletion_id}",
                "required_params": ["bulk_deletion_id"],
                "optional_params": ["after"],
            },
            "retrieve_chunk_deletion": {
                "http_method": "GET",
                "path": "/local-file-groups/{id}/chunk-deletions/{chunk_deletion_id}",
                "required_params": ["id", "chunk_deletion_id"],
                "optional_params": [],
            },
            "create": {
                "http_method": "POST",
